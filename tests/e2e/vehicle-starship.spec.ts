...
async function probeVehicleStarshipFlows(page: Page): Promise<ProbeResult> {
        ...
        try {
            ...
            if (s == null) {
                ...
                if (after === before + 1 && componentExists) {
                    ...
                    notes['starship-component-install'] = `expected items size ${before + 1} + shipComponent type, got size=${after} created=${JSON.stringify(
