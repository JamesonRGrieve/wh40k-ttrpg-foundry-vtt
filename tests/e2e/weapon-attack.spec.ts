...
async function probeWeaponAttackFlows(page: Page): Promise<ProbeResult> {
    ...
    try {
        const result = await page.evaluate(async (flows: readonly string[]): Promise<ProbeEvaluateResult> => {
            ...
            try {
                const probeRollsToHit = async (): Promise<void> => {
                    /* ============================================================
                ...
                const probeConsumesAmmo = async (): Promise<void> => {
                    /* ============================================================
                    ...
                    try {
                        ...
                        if (weapon == null) {
                            ...
                            if (after === before - 1 && usesAmmoBefore && usesAmmoAfter) {
                                ...
                                notes['weapon-attack-consumes-ammo'] = `expected ${before - 1}/usesAmmo=true, got clip=${after} usesAmmo=${String(
                                    usesAmmoAfter,
                                )}`;
                            }
                        }
                ...
                const probeOutOfAmmo = async (): Promise<void> => {
                    /* ============================================================
                    ...
                    try {
                        ...
                        if (weapon == null) {
                            ...
                            if (usesAmmo && isEmpty && clipValue === 0) {
                                ...
                                notes['weapon-attack-out-of-ammo'] = `expected usesAmmo=true isEmpty=true clip=0, got usesAmmo=${String(
                                    usesAmmo,
                                )} isEmpty=${String(isEmpty)} clip=${clipValue}`;
                            }
                        }
                    } catch (err) {
                ...
                const probePsychicPower = async (): Promise<void> => {
                    /* ============================================================
                ...
                const probeWeaponModes = async (): Promise<void> => {
                    /* ============================================================
                     * Flow 7: weapon-modes
