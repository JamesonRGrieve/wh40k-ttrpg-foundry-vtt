...
type FlowName = (typeof APP_API_DEPTH_FLOWS)[number];
    ...
    try {
        const result = await page.evaluate(async (flows: readonly string[]) => {
            ...
            try {
                 ...
                 * ============================================================ */
                try {
                    const mod = await import(`${base}/applications/api/drag-drop-api-mixin.js`);
                ...
                try {
                    ...
                    if (live == null) {
                        ...
                        if (stack == null || single == null || talent == null) {
                            ...
                            const mod = await import(`${base}/applications/api/drag-drop-visual-mixin.js`);
                ...
                try {
                    ...
                    if (typeof EnhancedDragDropMixin !== 'function') {
                        ...
                        const Mixed = EnhancedDragDropMixin(StubBase as any);
                        const inst = new Mixed();
                        const weaponInPrimary = inst._validateEquipmentSlot({ type: 'weapon' } as any, 'primary-weapon');
                        const weaponInArmor = inst._validateEquipmentSlot({ type: 'weapon' } as any, 'body-armor');
                        const armourInArmor = inst._validateEquipmentSlot({ type: 'armour' } as any, 'body-armor');
                 ...
                 * ============================================================ */
                try {
                    const mod = await import(`${base}/applications/api/expandable-tooltip-mixin.js`);
                    ...
                    if (typeof ExpandableTooltipMixin !== 'function') {
                        ...
                        const Mixed = ExpandableTooltipMixin(StubBase as any);
                        ...
                        if (typeof action !== 'function') {
                            ...
                            const openReported = inst.isPanelOpen('probe') === true;
                ...
                try {
                    ...
                    if (typeof ExpandableTooltipMixin !== 'function') {
                        ...
                        const isOpenA = inst.isPanelOpen('a') === true;
                        const isOpenB = inst.isPanelOpen('b') === true;
                        inst.closeExpandable('a');
                        const closedA = inst.isPanelOpen('a') === false;
                        const stillOpenB = inst.isPanelOpen('b') === true;
                 ...
                 * ============================================================ */
                try {
                    const mod = await import(`${base}/applications/api/visual-feedback-mixin.js`);
                    ...
                    if (typeof VisualFeedbackMixin !== 'function') {
                        ...
                        const Mixed = VisualFeedbackMixin(StubBase as any);
                        const inst = new Mixed();
                ...
                try {
                    ...
                    if (typeof VisualFeedbackMixin !== 'function') {
                        ...
                        class StubBase {
                            ...
                            document = {
                                toObject: () => ({ system: { wounds: { value: 5 }, name: 'alice' } }),
                            };
                        }
                        const Mixed = VisualFeedbackMixin(StubBase as any);
                        const inst = new Mixed();
                 ...
                 * ============================================================ */
                try {
                    const mod = await import(`${base}/applications/components/wh40k-tooltip.js`);
                ...
                try {
                    ...
                    if (typeof TooltipsWH40K !== 'function' || typeof prepareArmorTooltipData !== 'function') {
                        ...
                        const charJson = prepareCharacteristicTooltipData(
                            'weaponSkill',
                            { label: 'Weapon Skill', base: 30, advance: 5, modifier: 0, unnatural: 1, total: 35, bonus: 3 } as any,
                            {},
                        );
                 ...
                 * ============================================================ */
                try {
                    const mod = await import(`${base}/icons/icon.js`);
                 ...
                 * ============================================================ */
                try {
                    const mod = await import(`${base}/icons/helper.js`);
                    const { registerIconHelper } = mod;
                    const iconMod = await import(`${base}/icons/icon.js`);
                    const { icon } = iconMod;
                    if (typeof registerIconHelper !== 'function' || typeof icon !== 'function') {
                        ...
                        const HB = (g.Handlebars as { helpers: Record<string, unknown> } | undefined) ?? null;
                        if (HB == null) {
                ...
                try {
                    ...
                    if (typeof ApplicationV2Mixin !== 'function') {
                        ...
                        const Mixed = ApplicationV2Mixin(StubBase as any);
                        const inst = new Mixed();
                        // Reach into the prototype: _disableFields is defined on Mixed.
                        const disableFn = (Mixed.prototype as { _disableFields?: () => void })._disableFields;
                ...
                try {
                    ...
                    if (live == null) {
                        ...
                        if (typeof WhatIfMixin !== 'function') {
                            ...
                            const inactive = inst._whatIfActive === false;
