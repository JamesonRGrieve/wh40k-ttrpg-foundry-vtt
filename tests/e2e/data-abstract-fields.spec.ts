...
async function probeAbstractFields(page: Page): Promise<{ results: FlowResult[] }> {
    const results = await page.evaluate(async (): Promise<FlowResult[]> => {
        ...
        const identifierFlowKeys = ['identifier-field-defaults-blank', 'identifier-field-validateType-branches', 'identifier-field-fromName-kebab'] as const;
