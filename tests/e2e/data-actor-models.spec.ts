 ...
 * `SystemConfig.usesAptitudes` — aptitude systems (bc, dh2e, ow, im) use
 * `charTotal - 20`; career systems (dh1e, dw, rt) use `floor(charTotal/2)`.
            ...
            try {
                ...
                try {
                    ...
                    if (!pc) {
                        ...
                        if (total === 50 && bonus === 10) {
                            fired['characteristic-unnatural-multiplies-bonus::dh2e'] = true;
                        } else {
                            note('characteristic-unnatural-multiplies-bonus::dh2e', `expected total=50 bonus=10 (5*2), got total=${total} bonus=${bonus}`);
                        }
                    }
                } catch (err) {
                ...
                try {
                    ...
                    if (!pc) {
                        ...
                        if (total === 33 && bonus === 3) {
                            fired['characteristic-damage-subtracts::dh2e'] = true;
                        } else {
                            note('characteristic-damage-subtracts::dh2e', `expected total=33 (40-7) bonus=3, got total=${total} bonus=${bonus}`);
                        }
                    }
                } catch (err) {
                ...
                try {
                    ...
                    if (!pc) {
                        ...
                        if (ok) {
                            fired['skill-rank-flags::dh2e'] = true;
                        } else {
                            note(
                                'skill-rank-flags::dh2e',
                ...
                try {
                    ...
                    if (!pc) {
                        ...
                        if (rank === 2 && current === 50) {
                            fired['skill-trained-uses-full-characteristic::dh2e'] = true;
                        } else {
                            note(
                                'skill-trained-uses-full-characteristic::dh2e',
                ...
                try {
                    ...
                    if (!pc) {
                        ...
                        if (ok) {
                            fired['movement-derives-from-ab-and-size::dh2e'] = true;
                        } else {
                            note(
                                'movement-derives-from-ab-and-size::dh2e',
                ...
                try {
                    ...
                    if (!pc) {
                        ...
                        if (ok) {
                            fired['lifting-and-leap-from-strength-bonus::dh2e'] = true;
                        } else {
                            note(
                                'lifting-and-leap-from-strength-bonus::dh2e',
                ...
                try {
                    ...
                    if (!pc) {
                        ...
                        if (fatigueMax === 4) {
                            fired['fatigue-max-from-toughness-bonus::dh2e'] = true;
                        } else {
                            note('fatigue-max-from-toughness-bonus::dh2e', `expected fatigue.max=4 (TB of toughness 45), got ${fatigueMax}`);
                        }
                    }
                } catch (err) {
                ...
                try {
                    ...
                    if (!pc) {
                        ...
                        if (currentRating === 3 && isPsyker === true) {
                            fired['psy-current-rating-and-isPsyker::dh2e'] = true;
                        } else {
                            note(
                                'psy-current-rating-and-isPsyker::dh2e',
                ...
                try {
                    ...
                    if (!pc) {
                        ...
                        if (available === 650) {
                            fired['experience-available-derived::dh2e'] = true;
                        } else {
                            note('experience-available-derived::dh2e', `expected available=650 (1000-350), got ${available}`);
                        }
                    }
                } catch (err) {
                ...
                try {
                    ...
                    if (!pc) {
                        ...
                        if (ok) {
                            fired['wounds-fate-resources-roundtrip::dh2e'] = true;
                        } else {
                            note(
                                'wounds-fate-resources-roundtrip::dh2e',
                ...
                try {
                    ...
                    if (!pc) {
                        ...
                        if (level === 'corrupted' && degrees === 3) {
                            fired['corruption-level-and-insanity-degrees::dh1e'] = true;
                        } else {
                            note(
                                'corruption-level-and-insanity-degrees::dh1e',
                ...
                try {
                    ...
                    if (!pc) {
                        ...
                        if (sub?.value === 40 && sub?.max === 80 && inf === 55) {
                            fired['subtlety-and-influence-roundtrip::dh2e'] = true;
                        } else {
                            note(
                                'subtlety-and-influence-roundtrip::dh2e',
                ...
                try {
                    ...
                    if (!pc) {
                        ...
                        const inf = pc.system?.influence ?? -1;
                        if (inf === 100) {
                            fired['influence-clamps-to-percentile-ceiling::dh2e'] = true;
                        } else {
                            note('influence-clamps-to-percentile-ceiling::dh2e', `expected influence clamped to 100, got ${inf}`);
                        }
                    }
                } catch (err) {
