...
const MOD = await import('./bc-npc').catch((err) => {
    ...
    console.warn(`WH40KBCNPC could not be imported in this environment: ${msg}`);
    return undefined;
});
...
describe('WH40KBCNPC', () => {
    it.skipIf(MOD === undefined)('exports a default WH40KBCNPC class', () => {
        expect(MOD?.default).toBeTruthy();
    });

    it.skipIf(MOD === undefined || BASE_MOD === undefined || ROOT_NPC_MOD === undefined)('WH40KBCNPC extends NPCDocBase (and therefore WH40KNPC)', () => {
