...
export class HandlebarManager {
    ...
    static preloadHandlebarsTemplates() {
        const templates = [
            ...
            'systems/wh40k-rpg/templates/actor/acolyte/header.hbs',
            'systems/wh40k-rpg/templates/actor/acolyte/tabs.hbs',
            'systems/wh40k-rpg/templates/actor/acolyte/tabs-sidebar.hbs',
            'systems/wh40k-rpg/templates/actor/acolyte/body.hbs',
            'systems/wh40k-rpg/templates/actor/acolyte/tab-overview.hbs',
            'systems/wh40k-rpg/templates/actor/acolyte/tab-status.hbs',
            'systems/wh40k-rpg/templates/actor/acolyte/tab-combat.hbs',
            'systems/wh40k-rpg/templates/actor/acolyte/tab-skills.hbs',
            'systems/wh40k-rpg/templates/actor/acolyte/tab-talents.hbs',
            'systems/wh40k-rpg/templates/actor/acolyte/tab-equipment.hbs',
            'systems/wh40k-rpg/templates/actor/acolyte/tab-powers.hbs',
            'systems/wh40k-rpg/templates/actor/acolyte/tab-dynasty.hbs',
            'systems/wh40k-rpg/templates/actor/acolyte/tab-biography.hbs',
