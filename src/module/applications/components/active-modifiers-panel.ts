...
type ActorSheetCtor = new (...args: any[]) => foundry.appv1.sheets.ActorSheet; // eslint-disable-line @typescript-eslint/no-explicit-any -- mixin constructor signature must use any[] per TS mixin rule
