...
export const RANGED_ATTACK_MODES = [
    ...
    },
    {
        ...
        modifier: 0,
        icon: 'fas fa-burst',
        tooltip: 'Fire a burst. +0 BS. Additional hit per 2 DoS. Jam on 94+.',
    ...
    },
    {
        ...
        tooltip: 'Spray fire. -10 BS. Additional hit per DoS. Jam on 94+.',
        requires: (weapon) => (weapon.system.attack?.rateOfFire?.full ?? 0) > 0,
    },
    {
        key: 'suppressingSemi',
        label: 'Suppress (Semi)',
        actionName: 'Suppressing Fire - Semi',
        actionCost: 'Full',
        modifier: -20,
        icon: 'fas fa-shield-halved',
        tooltip: 'Semi-auto in 30° arc at -20 BS. Enemies must pass -10 Pinning test.',
        requires: (weapon) => (weapon.system.attack?.rateOfFire?.semi ?? 0) > 0,
    },
    {
        key: 'suppressingFull',
