 ...
 *
 * Foundry CORE icons (`icons/svg/*`), which ship with Foundry and therefore
 * always resolve. These used to be `modules/game-icons-net-font/...` paths —
 * an optional module whose manifest is a dead 404, so on any world without it
 * every one of these was a broken image (#239).
...
WH40K.defaultIcons = {
    ...
    trait: 'icons/svg/mystery-man.svg',
    psychicPower: 'icons/svg/lightning.svg',
    skill: 'icons/svg/target.svg',
    cybernetic: 'icons/svg/upgrade.svg',
    forceField: 'icons/svg/holy-shield.svg',
    attackSpecial: 'icons/svg/acid.svg',
    weaponMod: 'icons/svg/clockwork.svg',
    criticalInjury: 'icons/svg/bones.svg',
    origin: 'icons/svg/direction.svg',

    // Actor types
    character: 'icons/svg/cowled.svg',
    npc: 'icons/svg/mystery-man.svg',
    vehicle: 'icons/svg/direction.svg',
    terracraft: 'icons/svg/direction.svg',
    aircraft: 'icons/svg/wing.svg',
    watercraft: 'icons/svg/anchor.svg',
    starship: 'icons/svg/tower.svg',
    voidcraft: 'icons/svg/tower.svg',
};

/**
 * Foundry core icon path. These ship WITH Foundry, so they always resolve —
 * unlike the previous `modules/game-icons-net-font/...` paths, which pointed at
 * an optional module whose manifest is a dead 404, so every skill icon was a
 * broken image on any world that had not installed it (#239).
 */
const coreIcon = (name: string): string => `icons/svg/${name}.svg`;

WH40K.skillIcons = {
    acrobatics: coreIcon('jump'),
    athletics: coreIcon('walk'),
    awareness: coreIcon('eye'),
    barter: coreIcon('card-hand'),
    blather: coreIcon('card-hand'),
    carouse: coreIcon('target'),
    charm: coreIcon('card-hand'),
    chemUse: coreIcon('pill'),
    ciphers: coreIcon('padlock'),
    climb: coreIcon('mountain'),
    command: coreIcon('combat'),
    commerce: coreIcon('card-hand'),
    commonLore: coreIcon('eye'),
    concealment: coreIcon('invisible'),
    contortionist: coreIcon('card-hand'),
    deceive: coreIcon('invisible'),
    demolition: coreIcon('explosion'),
    disguise: coreIcon('mystery-man'),
    dodge: coreIcon('walk'),
    drive: coreIcon('direction'),
    evaluate: coreIcon('eye'),
    forbiddenLore: coreIcon('aura'),
    gamble: coreIcon('card-joker'),
    inquiry: coreIcon('eye'),
    interrogation: coreIcon('card-hand'),
    intimidate: coreIcon('skull'),
    invocation: coreIcon('lightning'),
    linguistics: coreIcon('card-hand'),
    lipReading: coreIcon('eye'),
    literacy: coreIcon('eye'),
    logic: coreIcon('clockwork'),
    medicae: coreIcon('heal'),
    navigate: coreIcon('direction'),
    navigation: coreIcon('direction'),
    operate: coreIcon('up'),
    parry: coreIcon('sword'),
    performer: coreIcon('card-hand'),
    pilot: coreIcon('up'),
    psyniscience: coreIcon('lightning'),
    scholasticLore: coreIcon('eye'),
    scrutiny: coreIcon('eye'),
    search: coreIcon('eye'),
    secretTongue: coreIcon('card-hand'),
    security: coreIcon('padlock'),
    shadowing: coreIcon('invisible'),
    silentMove: coreIcon('invisible'),
    sleightOfHand: coreIcon('card-hand'),
    speakLanguage: coreIcon('card-hand'),
    stealth: coreIcon('invisible'),
    survival: coreIcon('fire'),
    swim: coreIcon('walk'),
    techUse: coreIcon('clockwork'),
    tracking: coreIcon('target'),
    trade: coreIcon('item-bag'),
    wrangling: coreIcon('net'),
};
