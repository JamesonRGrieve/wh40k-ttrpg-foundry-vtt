...
export class HooksManager {
    ...
    static init(): void {
        ...
        (CONFIG.Actor as Record<string, unknown>)['documentClasses'] = {
            ...
            'dh2-terracraft': documents.WH40KDH2Vehicle,
            'dh2-aircraft': documents.WH40KDH2Vehicle,
            'dh1-character': documents.WH40KDH1Character,
            'dh1-npc': documents.WH40KDH1NPC,
            'dh1-terracraft': documents.WH40KDH1Vehicle,
            'rt-character': documents.WH40KRTCharacter,
            'rt-npc': documents.WH40KRTNPC,
            'rt-terracraft': documents.WH40KRTVehicle,
            'rt-aircraft': documents.WH40KRTVehicle,
            'rt-voidcraft': documents.WH40KRTVoidcraft,
            'bc-character': documents.WH40KBCCharacter,
            'bc-npc': documents.WH40KBCNPC,
            'bc-terracraft': documents.WH40KBCVehicle,
            'ow-character': documents.WH40KOWCharacter,
            'ow-npc': documents.WH40KOWNPC,
            'ow-terracraft': documents.WH40KOWVehicle,
            'ow-aircraft': documents.WH40KOWVehicle,
            'dw-character': documents.WH40KDWCharacter,
            'dw-npc': documents.WH40KDWNPC,
            'dw-terracraft': documents.WH40KDWVehicle,
            'dw-aircraft': documents.WH40KDWVehicle,
            'im-character': documents.WH40KIMCharacter,
            'im-npc': documents.WH40KIMNPC,
            'im-terracraft': documents.WH40KIMVehicle,
            ...
            'rt-starship': documents.WH40KRTVoidcraft,
            ...
            'terracraft': documents.WH40KDH2Vehicle,
            'aircraft': documents.WH40KDH2Vehicle,
            'starship': documents.WH40KRTVoidcraft,
            'voidcraft': documents.WH40KRTVoidcraft,
        };
