...
export class HooksManager {
    ...
    static registerHooks(): void {
        ...
        Hooks.on('getActorSheetClass', HooksManager.getActorSheetClass.bind(HooksManager));
    ...
    static init(): void {
        ...
        CFG.wh40k = WH40K;
        (CFG as any).Combat.initiative = { formula: '@initiative.base + @initiative.bonus', decimals: 0 };
        (CFG as any).MeasuredTemplate.defaults.angle = 30.0;

        // Define custom Document classes
        (CFG as any).Actor.documentClass = WH40KActorProxy;
        (CFG as any).Actor.documentClasses = {
            character: documents.WH40KAcolyte,
            npc: documents.WH40KNPCV2,
            vehicle: documents.WH40KVehicle,
            starship: documents.WH40KStarship,
        };
        (CFG as any).Item.documentClass = WH40KItem;
        (CFG as any).ActiveEffect.documentClass = documents.WH40KActiveEffect;
        (CFG as any).ChatMessage.documentClass = documents.ChatMessageWH40K;

        // Token document and movement
        (CFG as any).Token.documentClass = documents.TokenDocumentWH40K;
        (CFG as any).Token.rulerClass = TokenRulerWH40K;

        // Register custom Roll classes for serialization/deserialization
        (CFG as any).Dice.rolls.push(dice.BasicRollWH40K, dice.D100Roll);

        // Register data models for actors
        // DataModels handle schema validation and data preparation
        (CFG as any).Actor.dataModels = {
        ...
        const DocumentSheetConfig = (foundry.applications.apps as any).DocumentSheetConfig;

        // Unregister core V1 actor sheet and register V2 actor sheets
        DocumentSheetConfig.unregisterSheet(Actor, 'core', foundry.appv1.sheets.ActorSheet);
        DocumentSheetConfig.registerSheet(Actor, SYSTEM_ID, DarkHeresy2Sheet as any, {
            types: ['character'],
            makeDefault: true,
            label: 'WH40K.Sheet.DarkHeresy2',
        });
        DocumentSheetConfig.registerSheet(Actor, SYSTEM_ID, DarkHeresy1Sheet as any, {
            types: ['character'],
            makeDefault: false,
            label: 'WH40K.Sheet.DarkHeresy1',
        });
        DocumentSheetConfig.registerSheet(Actor, SYSTEM_ID, RogueTraderSheet as any, {
            types: ['character'],
            makeDefault: false,
            label: 'WH40K.Sheet.RogueTrader',
        });
        DocumentSheetConfig.registerSheet(Actor, SYSTEM_ID, BlackCrusadeSheet as any, {
            types: ['character'],
            makeDefault: false,
            label: 'WH40K.Sheet.BlackCrusade',
        });
        DocumentSheetConfig.registerSheet(Actor, SYSTEM_ID, OnlyWarSheet as any, {
            types: ['character'],
            makeDefault: false,
            label: 'WH40K.Sheet.OnlyWar',
        });
        DocumentSheetConfig.registerSheet(Actor, SYSTEM_ID, DeathwatchSheet as any, {
            types: ['character'],
            makeDefault: false,
            label: 'WH40K.Sheet.Deathwatch',
        });
        DocumentSheetConfig.registerSheet(Actor, SYSTEM_ID, CharacterSheetSidebar as any, {
            types: ['character'],
            makeDefault: false,
            label: 'WH40K.Sheet.PlayerCharacterSidebar',
        });
        DocumentSheetConfig.registerSheet(Actor, SYSTEM_ID, NPCSheetV2 as any, {
            types: ['npc'],
            makeDefault: true,
            label: 'WH40K.Sheet.NPC',
        });
        DocumentSheetConfig.registerSheet(Actor, SYSTEM_ID, VehicleSheet as any, {
            types: ['vehicle'],
            makeDefault: true,
            label: 'WH40K.Sheet.Vehicle',
        });
        DocumentSheetConfig.registerSheet(Actor, SYSTEM_ID, StarshipSheet as any, {
            types: ['starship'],
            makeDefault: true,
        ...
        DocumentSheetConfig.unregisterSheet(Item as any, 'core', foundry.appv1.sheets.ItemSheet);

        // Default item sheet for unspecified types
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, BaseItemSheet, {
            makeDefault: true,
            label: 'WH40K.Sheet.Item',
        });

        // Weapon sheet
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, WeaponSheet, {
            types: ['weapon'],
            makeDefault: true,
        ...
        // Armour sheet
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, ArmourSheet, {
            types: ['armour'],
            makeDefault: true,
        ...
        // Talent sheet
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, TalentSheet, {
            types: ['talent'],
            makeDefault: true,
        ...
        // Trait sheet
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, TraitSheet, {
            types: ['trait'],
            makeDefault: true,
        ...
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, GearSheet, {
        ...
        // Ammunition sheet
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, AmmoSheet, {
            types: ['ammunition'],
            makeDefault: true,
        ...
        // Psychic Power sheet
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, PsychicPowerSheet, {
            types: ['psychicPower'],
            makeDefault: true,
        ...
        // Skill sheet
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, SkillSheet, {
            types: ['skill'],
            makeDefault: true,
        ...
        // Cybernetic sheet
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, CyberneticSheet, {
            types: ['cybernetic'],
            makeDefault: true,
        ...
        // Force Field sheet
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, ForceFieldSheet, {
            types: ['forceField'],
            makeDefault: true,
        ...
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, CriticalInjurySheet, {
        ...
        // Condition sheet
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, ConditionSheet, {
            types: ['condition'],
            makeDefault: true,
        ...
        // Combat Action sheet
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, CombatActionSheet, {
            types: ['combatAction'],
            makeDefault: true,
        ...
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, StorageLocationSheet, {
        ...
        // Peer/Enemy sheet
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, PeerEnemySheet, {
            types: ['peer', 'enemy'],
            makeDefault: true,
        ...
        // Journal Entry sheet
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, JournalEntryItemSheet, {
            types: ['journalEntry'],
            makeDefault: true,
        ...
        // Origin Path sheet
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, OriginPathSheet, {
            types: ['originPath'],
            makeDefault: true,
        ...
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, WeaponModSheet, {
        ...
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, ArmourModSheet, {
        ...
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, AttackSpecialSheet, {
            types: ['attackSpecial'],
            makeDefault: true,
        ...
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, WeaponQualitySheet, {
            types: ['weaponQuality'],
            makeDefault: true,
        ...
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, ShipComponentSheet, {
            types: ['shipComponent'],
            makeDefault: true,
        ...
        // Ship Weapon sheet
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, ShipWeaponSheet, {
            types: ['shipWeapon'],
            makeDefault: true,
        ...
        // Ship Upgrade sheet
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, ShipUpgradeSheet, {
            types: ['shipUpgrade'],
            makeDefault: true,
        ...
        // NPC Template sheet
        DocumentSheetConfig.registerSheet(Item as any, SYSTEM_ID, NPCTemplateSheet, {
            types: ['npcTemplate'],
            makeDefault: true,
        ...
        (CFG as any).Token.movement.costAggregator = (results: any, distance: any, segment: any) => {
    ...
    static hotbarDrop(bar: any, data: any, slot: any): boolean {
    ...
    static renderCompendiumDirectory(app: any, html: any, data: any): void {
     ...
     */
    static getActorSheetClass(actor: any, sheetData: any): string | null {
